...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  String? _validateDocument(String value) {
    ...
    return pattern.hasMatch(value)
        ? null
        : 'Invalid ${_documentType.replaceAll('_', ' ')} format';
  }
  ...
  Future<void> _save() async {
    ...
    if (docError != null) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text(docError), backgroundColor: AppColors.error),
      );
      return;
    }
        ...
        children: [
          ...
          TextField(
            ...
            decoration: InputDecoration(
              ...
              helperText: _documentType == 'iqama'
                  ? '10 digits'
                  : 'Global alphanumeric format',
