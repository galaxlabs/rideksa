...
class _BookingDetailScreenState extends State<BookingDetailScreen> {
  ...
  bool get _canCancel {
    ...
    if (b['can_cancel'] == false) return false;
  ...
  Future<void> _cancel() async {
    final confirmed = await showDialog<bool>(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text(
          'This will cancel the booking. Depending on the policy, a penalty may apply.',
        ),
        actions: [
          TextButton(
            ...
            child: Column(
              children: [
                ...
                _row(
                  Icons.people,
                  'Passengers',
                  '${b['passenger_count'] ?? b['seat_count'] ?? 1}',
                ),
                _row(
                  Icons.schedule,
                  'Negotiation',
          ...
          _SectionCard(
            ...
            child: Column(
              children: [
                ...
                if (b['minimum_offer_fare'] != null)
                  _row(
                    Icons.trending_down,
                    'Minimum Offer',
                    '﷼ ${b['minimum_offer_fare']}',
                  ),
                if (b['maximum_offer_fare'] != null)
                  _row(
                    Icons.trending_up,
                    'Maximum Offer',
                    '﷼ ${b['maximum_offer_fare']}',
                  ),
                if (b['platform_fee_amount'] != null)
                  _row(
                    Icons.percent,
                    'Platform Fee',
                  ...
                  return Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(
                          child: Text(
                            '${o['vehicle'] ?? 'Vehicle'}  •  ${o['captain_user'] ?? ''}',
